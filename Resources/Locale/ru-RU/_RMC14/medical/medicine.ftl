...
reagent-desc-rmclipozine = Снижает чувство сытости и уменьшает массу тела за счет усиления кетоза и ускорения метаболизма жиров. Используется для лечения ожирения. Большие дозы могут привести к резкой потере веса.
